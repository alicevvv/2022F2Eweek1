    ...
    return(
        <div className="py-12">
            ...
            <div className='flex items-center mb-16'>
                ...
                <div className='text-6xl text-lightBlue font-bold text-left tracking-wider leading-normal'>
                    羨慕別人的<br/>酷酷網頁動畫？</div>
            </div>
            <div className='flex items-center mb-16'>
                <div className='text-6xl text-lightBlue font-bold text-right tracking-wider leading-normal'>
                    滿足不了<br/>同事的許願？</div>
                <img src={right1} alt="插圖"></img>
                <img src={err} className='absolute' alt='插圖' style={{marginLeft:'45%',marginTop:'-10%'}}></img>
            </div>
            <div className='flex items-center mb-16'>
                <img src={left2} alt="插圖"></img>
                <img src={ques} className='absolute' alt='插圖' style={{marginLeft:'20%',marginTop:'-10%'}}></img>
                <div className='text-6xl text-lightBlue font-bold text-left tracking-wider leading-normal'>
                    動畫技能樹太雜<br/>無從下手？</div>
            </div>
